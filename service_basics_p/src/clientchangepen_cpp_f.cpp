...
void cpp_callback(turtlesim::Pose pose_message){
    is_turtle_outside = (pose_message.x<2)||(pose_message.x>8)||(pose_message.y<2)||(pose_message.y>8); 
}
...
int main(int argc, char **argv){
    ...
    ros::Subscriber pos_sub_cpp = nh.subscribe("turtle1/pose",10,cpp_callback);
